...
<body>
    <h1>AddfoodIDkfc_UPDATE</h1>



    <form action="addfoodIDkfc_UPDATE.php" method="POST">
...
try {
    ...
    if (isset($_POST['foodID']) && isset($_POST['foodName'])) :
        // echo "<br>" . $_POST['fooodID'] . $_POST['foodName'] . $_POST['foodDescription'] . $_POST['foodPrice'] .
        //     $_POST['MenuID'] . $_POST['outstandingDebt'];

        require 'connect.php';
        $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
        $sql = "UPDATE tbl_food SET foodName = :foodName, foodDescription= :foodDescription, foodPrice = :foodPrice,
        menuID = :menuID WHERE foodID = :foodID";
